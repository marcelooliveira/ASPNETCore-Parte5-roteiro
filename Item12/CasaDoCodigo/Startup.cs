            ...
            IServiceProvider serviceProvider)
        {
            ...
            app.UseMvc(routes =>
            {
                ...
                routes.MapAreaRoute(
                    name: "AreaCarrinho",
                    areaName: "Carrinho",
                    template: "Carrinho/{controller=Carrinho}/{action=Index}/{codigo?}");

                routes.MapAreaRoute(
                    name: "AreaCadastro",
                    areaName: "Cadastro",
                    template: "Cadastro/{controller=Cadastro}/{action=Index}");

                routes.MapAreaRoute(
                    name: "AreaResumo",
                    areaName: "Resumo",
                    template: "Resumo/{controller=Resumo}/{action=Index}");
